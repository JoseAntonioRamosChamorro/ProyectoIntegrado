...
public class Quest3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView text_question = (TextView) findViewById(R.id.text_question3);
        text_question.setText(R.string.Listapreguntas3);

        String[] answers = getResources().getStringArray(R.array.preguntas3);
        ...
        final int correct_answer = getResources().getInteger(R.integer.respuestacorrecta3);
        final RadioGroup group = (RadioGroup) findViewById(R.id.answer_group3);
        ...
        btn_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(Quest3.this, Quest4.class);
